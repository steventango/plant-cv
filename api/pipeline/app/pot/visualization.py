...
def visualize_pot_detections(image_np: np.ndarray, boxes: np.ndarray, confidences: np.ndarray) -> np.ndarray:
    """
...
def visualize_pot_segmentation(image_np: np.ndarray, boxes: np.ndarray, masks: np.ndarray) -> np.ndarray:
    """
